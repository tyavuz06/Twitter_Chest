...
class db
{
  ...
  function __construct() {
    ...
    if($this->dbh = mysqli_connect($db_host, 
      ...
      mysqli_query($this->dbh, 'SET NAMES "utf8_turkish_ci"');
      mysqli_query($this->dbh, 'SET CHARACTER SET "utf8_turkish_ci"');
      mysqli_query($this->dbh, 'SET character_set_results = "utf8_turkish_ci",' .
        'character_set_client = "utf8_turkish_ci", character_set_connection = "utf8_turkish_ci",' .
        'character_set_database = "utf8_turkish_ci", character_set_server = "utf8_turkish_ci"');
    } else {
