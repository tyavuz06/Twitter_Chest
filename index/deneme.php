...
$hdp_sayac=0;
$ilkordinat=array(
	array("Adana",35.3308,36.9914,0),				//0
	array("Adıyaman",38.17,37.46,0),				//1
	array("Afyonkarahisar",30.7120,38.7391,0),		//2		
	array("Ağrı",43.03,39.44,0),					//3
	array("Ankara",32.8597,39.9334,0),				//4
	array("Antalya",30.7133,36.8969,0),				//5
	array("Aksaray",33.9750,38.3352,0),				//6
	array("Balıkesir",27.7373,39.5541,0),			//7
	array("Amasya",35.9038,40.6517,0),				//8
	array("Bartın",35.9038,40.6517,0),				//9
	array("Ardahan",32.4610,41.5811,0),				//10
	array("Artvin", 41.7628,41.0787,0),				//11
	array("Aydın",28.4864,37.8117,0),				//12
	array("Batman",41.1292,37.8895,0),				//13
	array("Bayburt",40.1619,40.1673,0),				//14
	array("Bilecik",30.0665,40.0567,0),				//15
	array("Bingöl",40.4966,38.8855,0),				//16
	array("Bitlis",42.4202,38.6523,0),				//17
	array("Bolu",31.5788,40.5760,0),				//18
	array("Burdur",30.0665,37.4613,0),				//19
	array("Bursa",29.0610,40.1885,0),				//20
	array("Çanakkale",26.4086,40.1467,0),			//21
	array("Çankırı",33.6162,40.6002,0),				//22
	array("Isparta",31.0794,38.0211,0),				//23
	array("İstanbul",28.9784,41.0082,0),			//24
	array("Çorum",34.9537,40.5499,0),				//25
	array("Denizli",29.2321,37.6128,0),				//26
	array("Diyarbakır",40.2110,37.9250,0),			//27
	array("Düzce",40.8771,31.3193,0),				//28
	array("Edirne",26.5557,41.6771,0),				//29
	array("Elazığ",39.2199,38.4965,0),				//30
	array("Erzincan",39.469,39.7148,0),				//31
	array("Erzurum",41.2658,39.9055,0),				//32
	array("Eskişehir",30.5256,39.7667,0),			//33
	array("Gaziantep",37.3781,37.0660,0),			//34
	array("Giresun",38.5936,40.6462,0),				//35
	array("Gümüşhane",39.3143,40.2804,0),			//36
	array("Hakkâri",43.7450,37.4459,0),				//37
	array("Hatay",36.4018,36.3498,0),				//38
	array("Mersin",34.6415,36.8121,0),				//39
	array("Iğdır",44.0048,39.8880,0),				//40
	array("İzmir",27.1428,38.4237,0),				//41
	array("Kahramanmaraş",36.9541,37.7503,0),		//42
	array("Karabük",32.7417,41.1875,0),				//43
	array("Karaman",33.2222,37.1810,0),				//44
	array("Kars",42.9768,40.6123,0),				//45
	array("Kastamonu",33.6998,41.4104,0),			//46
	array("Kayseri",35.4826,38.7205,0),				//47
	array("Kilis",37.1687,36.8205,0),				//48
	array("Kırıkkale",27.4838,41.7260,0),			//49
	array("Kırklareli",35.9038,40.6517,0),			//50
	array("Kırşehir",33.9750,39.2269,0),			//51
	array("Kocaeli",29.9408,40.7654,0),				//52
	array("Konya",32.4932,37.8746,0),				//53
	array("Kütahya",29.6035,39.3581,0),				//54
	array("Malatya",37.9536,38.4015,0),				//55
	array("Manisa",28.1123,38.8419,0),				//56
	array("Mardin",40.6196,37.3443,0),				//57
	array("Muğla",28.4864,37.1836,0),				//58
	array("Muş",41.4910,38.7346,0),					//59
	array("Nevşehir",34.6857,38.6939,0),			//60
	array("Niğde",34.6857,38.0993,0),				//61
	array("Ordu",40.7991,37.3899,0),				//62
	array("Osmaniye",36.1763,37.2130,0),			//63
	array("Rize",40.9227,40.9581,0),				//64
	array("Sakarya",30.3948,40.7731,0),				//65
	array("Samsun",36.3361,41.2797,0),				//66
	array("Şanlıurfa",39.1544,37.3569,0),			//67
	array("Siirt",42.1495,37.8659,0),				//68
	array("Sinop",35.1517,42.0280,0),				//69
	array("Şırnak",42.4918,37.4187,0),				//70	
	array("Sivas",37.1294,39.4488,0),				//71
	array("Tekirdağ",27.5117,40.9781,0),			//72
	array("Tokat",36.6252,40.3903,0),				//73
	array("Trabzon",39.5848,40.7992,0),				//74
	array("Tunceli",39.4388,39.3074,0),				//75
	array("Uşak",29.4059,38.6742,0),				//76
	array("Van",38.5012,43.3730,0),					//77
	array("Yalova",29.1623,40.5904,0),				//78
	array("Yozgat",34.8086,39.8210,0),				//79
	array("Zonguldak",31.8598,41.3125,0)			//80
	);
	
	//-------------------------------------------------------------------------------
	$sql=("SELECT * FROM tweets ORDER BY created_at ASC LIMIT 1"); 
	foreach($conn->query($sql) as $rs)
	{
		$created_at_begin=$rs['created_at'];
	}
	$sql=("SELECT * FROM tweets ORDER BY created_at DESC LIMIT 1"); 
	foreach($conn->query($sql) as $rs)
	{
		$created_at_finish=$rs['created_at'];
	}
		
	$date=date_create($created_at_begin); 
	date_add($date,date_interval_create_from_date_string("0 days"));
	$created_at_begin = date_format($date,"Y-m-d");
	$created_at_begin_b = $created_at_begin;
	
	$date=date_create($created_at_finish);
	date_add($date,date_interval_create_from_date_string("0 days"));
	$created_at_finish = date_format($date,"Y-m-d");
	$week_counter=0;
	$weeks =array();
	while(1)
	{
		
		if($created_at_begin > $created_at_finish)
			break;
		else{	
			$weeks[$week_counter]=$created_at_begin;
			//echo $weeks[$week_counter]."<br>";
			$date=date_create($created_at_begin);
	...
	//for ($kl=0; $kl<1; $kl++)
	for ($kl=0; $kl<count($weeks)-1; $kl++)
	{
		$a=$kl+1;		
		$sql=("SELECT * FROM `tweets` WHERE created_at BETWEEN '$weeks[$kl]' and '$weeks[$a]'"); 
		...
		foreach($conn->query($sql) as $rs)
		{
			...
			if($lat == 0 and $long == 0)
			{
				...
				{	
					$boolean_aktif=0;
					$sehir=$su['location'];
					for($i=0; $i<count($ilkordinat); $i++)
					{
						
						if(strstr($sehir,$ilkordinat[$i][0]) or strstr($sehir,strtoupper($ilkordinat[$i][0])) or strstr($sehir,strtolower($ilkordinat[$i][0])))
						{
							
							$ilkordinat[$i][3]+=1;
							if(strstr(strtolower($tweet),"akparti") or strstr(strtolower($tweet),"akp") or strstr($tweet,"Ak Parti") or strstr($tweet,"AkParti")) 
							{
								if(!strstr($tweet,"@Akparti"))
								{
									$tweet_sayac+=1;
									$ilkordinat[$i][4]+=1;
									$akp_sayac++;
							...
							if(strstr(strtolower($tweet),"milliyetcihareketpartisi") or strstr(strtolower($tweet),"mhp") or strstr($tweet,"Milliyetci Hareket Partisi")or strstr($tweet,"Milliyetçi Hareket Partisi"))
							{	
								if(!strstr($tweet,"@MHP_Bilgi"))
								{
									$tweet_sayac+=1;
									$ilkordinat[$i][5]+=1;
									$mhp_sayac++;
							...
							if(strstr(strtolower($tweet),"cumhuriyethalkpartisi") or strstr(strtolower($tweet),"chp") or strstr($tweet,"Cumhuriyet Halk Partisi"))
							{	
								if(!strstr($tweet,"@herkesicinCHP"))
								{
									$tweet_sayac+=1;
									$ilkordinat[$i][6]+=1;
									$chp_sayac++;
							...
							if(strstr(strtolower($tweet),"halklarındemokratpartisi") or strstr(strtolower($tweet),"halklarindemokratpartisi") or strstr(strtolower($tweet),"hdp") or strstr($tweet,"Hakların Demokrat Partisi")or strstr($tweet,"Halklarin Demokrat Partisi"))
							{
								if(!strstr($tweet,"@HDPgenelmerkezi"))
								{
									$tweet_sayac+=1;
									$ilkordinat[$i][7]+=1;
									$hdp_sayac++;
						...
						{
							if($i == 21 or $i == 41 or $i == 22 or $i == 24 or $i == 25)
							{
								if(strstr($sehir,"Istanbul") or strstr($sehir,"Canakkale") or strstr($sehir,"Cankiri") or strstr($sehir,"Corum") or strstr($sehir,"Izmir"))
								{
									$ilkordinat[$i][3]+=1;
									if(strstr(strtolower($tweet),"akparti") or strstr(strtolower($tweet),"akp") or strstr($tweet,"Ak Parti") or strstr($tweet,"AkParti")) 
									{
					...
					/*if($boolean_aktif==0)
					{
						$sql_sill = ("DELETE FROM tweets WHERE tweet_id=$id");
						if ($conn->query($sql_sill) === TRUE) {
							} else {

								echo "Gereksiz Kayıt Silindi.:<br>";
							}
					}*/
				}
			}
			else
			{
				...
				for($j=0; $j<81; $j++)
				{		
					$path=distance($lat,$long,$ilkordinat[$j][2],$ilkordinat[$j][1],"K");
		...
		/*$partiler= array(
		array(1,"Ak Parti","#00aafa"),		
		array(2,"Milliyetçi Hareket Partisi","#0065fa"),		
		array(3,"Cumhuritet Halk Partisi","#0025fa"),			
		array(4,"Halkların Demokratik Partisi","#0000fa"),	
		array(5,"Tweet yok","#252525")
		);
		for($twt=0; $twt<=80; $twt++) 
		{	
			...
			for($twj=4; $twj<=7; $twj++)
			{
				if($ilkordinat[$twt][$twj] >= $max_tweet)
				{
					$max_tweet=$ilkordinat[$twt][$twj];
					$parti_id=$partiler[$twj-4][0];
					$sparti=$partiler[$twj-4][1];			
				}
			}
			if($max_tweet==0)
			{
				$parti_renk[$twt]=$partiler[4][2];
				$parti_id=999;
				$sparti="";
			}
			else
				$parti_renk[$twt]=$partiler[$parti_id-1][2];
			//echo "<br>".$ilkordinat[$i][0]."İlinde: ".$ilkordinat[$i][3]." adet tweet ve en çok tweet atılan takım : ".$sparti."<br>".$ilkordinat[$i][4]." Ak Parti - ".$ilkordinat[$i][5]." Milliyetçi Hareket Partisi".$ilkordinat[$i][6]." Cumhuriyet Halk Partisi".$ilkordinat[$i][7]." Halkarların Demokrat Partisi<br><br>";
			$sql_abstract="UPDATE tweet_abstract_weekly SET max_tweet=$parti_id WHERE hafta_id=$a AND il_id=$twt";
			$conn->query($sql_abstract);
		}
		
		$dongu_girdi=1;
		$hafta=$kl+1;	
		$sql_control="SELECT * FROM tweet_abstract_weekly WHERE hafta_id=$hafta";
		foreach($conn->query($sql_control) as $kw)
		{
			$dongu_girdi=0;
			$hafta_id=$kw['hafta_id'];
			if ($hafta_id == $hafta) {
			} 
			else {	
				$akp_tweet=$ilkordinat[$xy][4];
				$mhp_tweet=$ilkordinat[$xy][5];
				$chp_tweet=$ilkordinat[$xy][6];
				$hdp_tweet=$ilkordinat[$xy][7];
				$sql_abstract=("INSERT INTO tweet_abstract_weekly(hafta_id,il_id,akp_oran,mhp_oran,chp_oran,hdp_oran) VALUES ('$hafta','$xy','$akp_tweet','$mhp_tweet','$chp_tweet','$hdp_tweet')");
				$conn->query($sql_abstract);
			}
			$dongu_girdi=0;
			break;
	...
	$partiler= array(
		array(1,"Ak Parti","#ed9600"),		
		array(2,"Milliyetçi Hareket Partisi","#0065fa"),		
		array(3,"Cumhuritet Halk Partisi","#c80814"),			
		array(4,"Halkların Demokratik Partisi","#8b008b"),	
		array(5,"Tweet yok","#AAAAAA")
	);
	for($i=0; $i<=80; $i++) 
	{	
		...
		for($j=4; $j<=7; $j++)
		{
			if($ilkordinat[$i][$j] >= $max_tweet)
			{
				$max_tweet=$ilkordinat[$i][$j];
				$parti_id=$partiler[$j-4][0];
				$sparti=$partiler[$j-4][1];			
			}
		}
		if($max_tweet==0)
		{
			$parti_renk[$i]=$partiler[4][2];
			$parti_id="";
			$sparti="";
		}
		else
			$parti_renk[$i]=$partiler[$parti_id-1][2];
		//echo "<br>".$ilkordinat[$i][0]."İlinde: ".$ilkordinat[$i][3]." adet tweet ve en çok tweet atılan takım : ".$sparti."<br>".$ilkordinat[$i][4]." Ak Parti - ".$ilkordinat[$i][5]." Milliyetçi Hareket Partisi".$ilkordinat[$i][6]." Cumhuriyet Halk Partisi".$ilkordinat[$i][7]." Halkarların Demokrat Partisi<br><br>";
	}
	for($i=0; $i<=80; $i++)
	{
		...
		for($j=4; $j<=7; $j++)
		{
			$toplam+=$ilkordinat[$i][$j];
		}
		$akpartioy[$i]=$ilkordinat[$i][4]/$toplam*100;
		$akpartioy[$i]=number_format($akpartioy[$i],2);
		$mhpoy[$i]=$ilkordinat[$i][5]/$toplam*100;
		$mhpoy[$i]=number_format($mhpoy[$i],2);
		$chpoy[$i]=$ilkordinat[$i][6]/$toplam*100;
		$chpoy[$i]=number_format($chpoy[$i],2);
		$hdpoy[$i]=$ilkordinat[$i][7]/$toplam*100;
		$hdpoy[$i]=number_format($hdpoy[$i],2);
	}
		$content = "<svg width='100%' height='400' xmlns='http://www.w3.org/2000/svg' xmlns:amcharts='http://amcharts.com/ammap' xmlns:xlink='http://www.w3.org/1999/xlink' version='1.1'>
		<defs>
			<style type='text/css'>
	...
	for($i=1; $i<5; $i++)
	{
		...
		for ($j=0; $j<=80; $j++)
		{
			...
			if($ilkordinat[$j][$i+3]>$max)
			{
				$toplam=$ilkordinat[$j][4]+$ilkordinat[$j][5]+$ilkordinat[$j][6]+$ilkordinat[$j][7];
				if($i==1)
				{
					$akpOran=$ilkordinat[$j][$i+3]/$toplam*100;
					$akpOran=number_format($akpOran,2);
					$diziAkp[$j][0]=$akpOran;
					$diziAkp[$j][1]=$ilkordinat[$j][0];
				}
				if($i==2)
				{
					
					$mhpOran=$ilkordinat[$j][$i+3]/$toplam*100;
					$mhpOran=number_format($mhpOran,2);
					$diziMhp[$j][0]=$mhpOran;
					$diziMhp[$j][1]=$ilkordinat[$j][0];
				}
				if($i==3)
				{
					
					$chpOran=$ilkordinat[$j][$i+3]/$toplam*100;
					$chpOran=number_format($chpOran,2);
					$diziChp[$j][0]=$chpOran;
					$diziChp[$j][1]=$ilkordinat[$j][0];
				}
				if($i==4)
				{
				
					$hdpOran=$ilkordinat[$j][$i+3]/$toplam*100;
					$hdpOran=number_format($hdpOran,2);
					$diziHdp[$j][0]=$hdpOran;
					$diziHdp[$j][1]=$ilkordinat[$j][0];
				}
			}	
	...
	rsort($diziChp);
	rsort($diziHdp);
	$toplam=$akp_sayac+$mhp_sayac+$chp_sayac+$hdp_sayac;
	
	$akp_sayac = $akp_sayac/$toplam*100;
	$genel_yuzde[0] = number_format($akp_sayac,2);
	$mhp_sayac=$mhp_sayac/$toplam*100;
	$genel_yuzde[1] = number_format($mhp_sayac,2);
	$chp_sayac=$chp_sayac/$toplam*100;
	$genel_yuzde[2] = number_format($chp_sayac,2);
	$hdp_sayac=$hdp_sayac/$toplam*100;
	$genel_yuzde[3] = number_format($hdp_sayac,2);		
	
	
	?>
<div class="takimlar">
	<table cellspacing="15" cellspacing="0">
	<tr align="center"><td><b>Parti Rengi</b></td><td><b>Parti İsmi</b></td><td><b>Genel Yüzde</b></td><td><b>En Yüksek 1. İl</b></td><td><b>En Yüksek 2. İl</b></td><td><b>En Yüksek 3. İl</b></td><td><b>En Yüksek 4. İl</b></td><td><b>En Yüksek 5. İl</b></td></tr>
	...
	?>
		<td>
		<?php echo "<svg width='75' height='10' version='1.1' xmlns='http://www.w3.org/2000/svg'><rect width='100' height='10'  style='fill:".$color."'/></svg>";?>
		</td>
		<td><?php echo $partiler[$i][1];?></td>
		<td><?php echo "%".$genel_yuzde[$i];?></td>
	<?php
			...
			for($j=0; $j<=4; $j++)
			{
				if($i==0)
				{
					?><td><?php echo $diziAkp[$j][1].":%".$diziAkp[$j][0];?></td><?php
					//echo $diziAkp[$j][1].":%".$akpOran."-";
				}
				if($i==1)
				{
				
					?><td><?php echo $diziMhp[$j][1].":%".$diziMhp[$j][0];?></td><?php
					//echo $diziMhp[$j][1].":%".$mhpOran."-";
				}
				if($i==2)
				{
					
					?><td><?php echo $diziChp[$j][1].":%".$diziChp[$j][0];?></td><?php
					//echo $diziChp[$j][1].":%".$chpOran."-";
				}
				if($i==3)
				{
					
					?><td><?php echo $diziHdp[$j][1].":%".$diziHdp[$j][0];?></td><?php
					//echo $diziHdp[$j][1].":%".$hdpOran."-";
				}
			}
		echo "</tr>";
	}
...
<div class="chart">
	...
	<?php
	include "footer.php";
	//echo "<br>TÜRKİYE ÇAPINDA:<br> AK PARTİ OY ORANI: %".$akp_sayac."MHP GENEL OY ORANI: %".$mhp_sayac." CHP OY ORANI: %".$chp_sayac." HDP OY ORANI: %".$hdp_sayac."<br>";
	mysql_close($conn);
?>