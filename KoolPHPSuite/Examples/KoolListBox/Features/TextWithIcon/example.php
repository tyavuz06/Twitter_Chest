<?php
	...
	$item->ImageUrl = "../../Images/flags/24/flag_mexico.png";
	
	$item = $item = $second_listbox->AddItem(new ListBoxItem("New Zealand"));
	$item->ImageUrl = "../../Images/flags/24/flag_new_zealand.png";
	
	$item = $second_listbox->AddItem(new ListBoxItem("South Africa"));
	$item->ImageUrl = "../../Images/flags/24/flag_south_africa.png";
	
	$item = $second_listbox->AddItem(new ListBoxItem("USA"));
	$item->ImageUrl = "../../Images/flags/24/flag_usa.png";
