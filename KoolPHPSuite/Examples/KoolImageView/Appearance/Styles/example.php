...
<form id="form1" method="post">
	...
	<style type="text/css">
		...
		div.framepic { width:96px; height:100px; padding : 2px; vertical-align:middle;}
		div.framepic1 { border : 2px  dotted gray; width:120px; }
		div.framepic2 { border : 2px dotted black ;  width : 124px;}		
		div.framepic3 { border : 2px solid gray ; padding : 1px ; width : 128px;}
	</style>
	<div class="box focus">
		<div class="framepic3">		
			<div class="framepic2">
